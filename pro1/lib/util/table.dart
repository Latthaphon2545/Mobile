...
Widget _buildBackrest() {
  return _buildContainer(
      width: 3, height: 52.5, color: const Color.fromRGBO(202, 255, 170, 1));
}

Widget _buildBackrestLand() {
  return _buildContainer(
      width: 52.5, height: 3, color: const Color.fromRGBO(202, 255, 170, 1));
}

// This method builds a chair
Widget _buildChair() {
  return _buildContainer(
      width: 30, height: 52.5, color: const Color.fromRGBO(202, 255, 170, 1));
}

Widget _buildChairLand() {
  return _buildContainer(
      width: 45, height: 30, color: const Color.fromRGBO(202, 255, 170, 1));
}
